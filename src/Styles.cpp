...
KeywordList KeyWords_HTML = { "!doctype ^aria- ^data- a abbr accept accept-charset accesskey acronym "
...
EditLexer lexHTML = {
    ...
    { { STYLE_DEFAULT, 63126, L"Default", L"", L"" },
      ...
      { MULTI_STYLE(SCE_HJ_COMMENT, SCE_HJ_COMMENTLINE, SCE_HJ_COMMENTDOC, 0), 63160, L"JS Comment", L"fore:#646464",
        L"" },
      { SCE_HJ_KEYWORD, 63163, L"JS Keyword", L"bold; fore:#A46000", L"" },
      { SCE_HJ_WORD, 63162, L"JS Identifier", L"", L"" },
      { MULTI_STYLE(SCE_HJ_DOUBLESTRING, SCE_HJ_SINGLESTRING, SCE_HJ_STRINGEOL, 0), 63164, L"JS String",
        L"fore:#008000", L"" },
      ...
      { MULTI_STYLE(SCE_HJA_COMMENT, SCE_HJA_COMMENTLINE, SCE_HJA_COMMENTDOC, 0), 63168, L"ASP JS Comment",
        L"fore:#646464", L"" },
      { SCE_HJA_KEYWORD, 63171, L"ASP JS Keyword", L"bold; fore:#A46000", L"" },
      { SCE_HJA_WORD, 63170, L"ASP JS Identifier", L"", L"" },
      { MULTI_STYLE(SCE_HJA_DOUBLESTRING, SCE_HJA_SINGLESTRING, SCE_HJA_STRINGEOL, 0), 63172, L"ASP JS String",
        L"fore:#008000", L"" },
...
KeywordList KeyWords_CSS = { "alignment-adjust alignment-baseline animation animation-delay "
...
EditLexer lexCSS = {
    ...
    { { STYLE_DEFAULT, 63126, L"Default", L"", L"" },
      ...
      { MULTI_STYLE(SCE_CSS_PSEUDOCLASS, SCE_CSS_EXTENDED_PSEUDOCLASS, 0, 0), 63197, L"Pseudo-class", L"fore:#B000B0",
        L"" },
      { MULTI_STYLE(SCE_CSS_PSEUDOELEMENT, SCE_CSS_EXTENDED_PSEUDOELEMENT, 0, 0), 63361, L"Pseudo-element",
        L"fore:#B00050", L"" },
      { SCE_CSS_UNKNOWN_PSEUDOCLASS, 63198, L"Unknown Pseudo-class", L"fore:#C80000; back:#FFFF80", L"" },
      { MULTI_STYLE(SCE_CSS_IDENTIFIER, SCE_CSS_IDENTIFIER2, SCE_CSS_IDENTIFIER3, SCE_CSS_EXTENDED_IDENTIFIER), 63199,
        L"CSS Property", L"fore:#FF4000", L"" },
...
EditLexer lexCPP = { SCLEX_CPP,
                     ...
                     { { STYLE_DEFAULT, 63126, L"Default", L"", L"" },
                       ...
                       { MULTI_STYLE(SCE_C_STRING, SCE_C_CHARACTER, SCE_C_STRINGEOL, SCE_C_VERBATIM), 63131, L"String",
                         L"fore:#008000", L"" },
...
KeywordList KeyWords_CS = { "abstract add alias as ascending async await base bool break by byte case "
                            "catch char checked "
...
EditLexer lexCS = { SCLEX_CPP,
                    ...
                    { { STYLE_DEFAULT, 63126, L"Default", L"", L"" },
                      ...
                      { SCE_C_IDENTIFIER, 63129, L"Identifier", L"", L"" },
                      { MULTI_STYLE(SCE_C_STRING, SCE_C_CHARACTER, SCE_C_STRINGEOL, 0), 63131, L"String",
                        L"fore:#008000", L"" },
...
EditLexer lexMAK = { SCLEX_MAKEFILE,
                     ...
                     { { STYLE_DEFAULT, 63126, L"Default", L"fore:#0A246A", L"" },
                       ...
                       { MULTI_STYLE(SCE_MAKE_IDENTIFIER, SCE_MAKE_IDEOL, 0, 0), 63129, L"Identifier", L"fore:#003CE6",
                         L"" },
...
KeywordList KeyWords_JAVA = { "@interface abstract assert boolean break byte case catch char class const "
...
KeywordList KeyWords_PAS = { "absolute abstract alias and array as asm assembler begin break case cdecl "
...
EditLexer lexPAS = {
    ...
    { { STYLE_DEFAULT, 63126, L"Default", L"", L"" },
      ...
      { MULTI_STYLE(SCE_PAS_COMMENT, SCE_PAS_COMMENT2, SCE_PAS_COMMENTLINE, 0), 63127, L"Comment", L"fore:#646464",
        L"" },
...
KeywordList KeyWords_ASM = { "aaa aad aam aas adc add and arpl bound bsf bsr bswap bt btc btr bts call "
...
KeywordList KeyWords_BAT = { "arp assoc attrib bcdedit bootcfg break cacls call cd change chcp chdir "
...
KeywordList KeyWords_SQL = { "abort accessible action add after all alter analyze and as asc asensitive "
...
KeywordList KeyWords_CONF = { "acceptmutex acceptpathinfo accessconfig accessfilename action addalt "
...
KeywordList KeyWords_PS = { "begin break catch continue data do dynamicparam else elseif end exit "
...
EditLexer lexPS = { SCLEX_POWERSHELL,
                    ...
                    { { STYLE_DEFAULT, 63126, L"Default", L"", L"" },
                      ...
                      { MULTI_STYLE(SCE_POWERSHELL_COMMENT, SCE_POWERSHELL_COMMENTSTREAM, 0, 0), 63127, L"Comment",
                        L"fore:#646464", L"" },
                      { SCE_POWERSHELL_KEYWORD, 63128, L"Keyword", L"bold; fore:#804000", L"" },
                      { SCE_POWERSHELL_IDENTIFIER, 63129, L"Identifier", L"", L"" },
                      { MULTI_STYLE(SCE_POWERSHELL_STRING, SCE_POWERSHELL_CHARACTER, 0, 0), 63131, L"String",
                        L"fore:#008000", L"" },
                      ...
                      { MULTI_STYLE(SCE_POWERSHELL_CMDLET, SCE_POWERSHELL_FUNCTION, 0, 0), 63250, L"Cmdlet",
                        L"fore:#804000; back:#FFF1A8", L"" },
                      { SCE_POWERSHELL_ALIAS, 63251, L"Alias", L"bold; fore:#0A246A", L"" },
                      { -1, 00000, L"", L"", L"" } } };

KeywordList KeyWords_NSIS = { "!addincludedir !addplugindir !appendfile !cd !define !delfile !echo !else "
                              "!endif !error "
...
EditLexer lexNSIS = { SCLEX_NSIS,
                      ...
                      { { STYLE_DEFAULT, 63126, L"Default", L"", L"" },
                        ...
                        { MULTI_STYLE(SCE_NSIS_COMMENT, SCE_NSIS_COMMENTBOX, 0, 0), 63127, L"Comment", L"fore:#008000",
                          L"" },
...
KeywordList KeyWords_INNO = { "code components custommessages dirs files icons ini installdelete "
...
EditLexer lexINNO = { SCLEX_INNOSETUP,
                      ...
                      { { STYLE_DEFAULT, 63126, L"Default", L"", L"" },
                        ...
                        { MULTI_STYLE(SCE_INNO_STRING_DOUBLE, SCE_INNO_STRING_SINGLE, 0, 0), 63131, L"String", L"",
                          L"" },
...
KeywordList KeyWords_LUA = { "and break do else elseif end false for function goto if "
...
KeywordList KeyWords_AU3 = { "and byref case const continuecase continueloop default dim do else elseif "
                             "endfunc endif "
...
EditLexer lexAU3 = { SCLEX_AU3,
                     ...
                     &KeyWords_AU3,
                     { { STYLE_DEFAULT, 63126, L"Default", L"", L"" },
                       { MULTI_STYLE(SCE_AU3_COMMENT, SCE_AU3_COMMENTBLOCK, 0, 0), 63127, L"Comment", L"fore:#008000",
                         L"" },
...
EditLexer lexLATEX = { SCLEX_LATEX,
                       63281,
                       L"LaTeX Files",
                       L"tex; latex; sty",
                       L"",
...
KeywordList KeyWords_AHK = { "break continue else exit exitapp gosub goto if ifequal ifexist ifgreater "
                             "ifgreaterorequal "
...
KeywordList KeyWords_CMAKE = { "add_custom_command add_custom_target add_definitions add_dependencies "
...
EditLexer lexCmake = { SCLEX_CMAKE,
                       63324,
                       L"Cmake Script",
                       L"cmake; ctest",
                       L"",
                       ...
                       { { STYLE_DEFAULT, 63126, L"Default", L"", L"" },
                         ...
                         { MULTI_STYLE(SCE_CMAKE_STRINGDQ, SCE_CMAKE_STRINGLQ, SCE_CMAKE_STRINGRQ, 0), 63131, L"String",
                           L"back:#EEEEEE; fore:#7F007F", L"" },
...
KeywordList KeyWords_AVS = { "true false return global",
...
EditLexer lexAVS = { SCLEX_AVS,
                     ...
                     { { STYLE_DEFAULT, 63126, L"Default", L"", L"" },
                       ...
                       { MULTI_STYLE(SCE_AVS_COMMENTLINE, SCE_AVS_COMMENTBLOCK, SCE_AVS_COMMENTBLOCKN, 0), 63127,
                         L"Comment", L"fore:#008000", L"" },
                       { SCE_AVS_OPERATOR, 63132, L"Operator", L"", L"" },
                       { MULTI_STYLE(SCE_AVS_STRING, SCE_AVS_TRIPLESTRING, 0, 0), 63131, L"String", L"fore:#7F007F",
                         L"" },
...
EditLexer lexYAML = { SCLEX_YAML,
                      ...
                      { { STYLE_DEFAULT, 63126, L"Default", L"", L"" },
                        ...
                        { SCE_YAML_ERROR, 63359, L"Error", L"fore:#FFFFFF; bold; italic; back:#FF0000; eolfilled",
                          L"" },
                        { SCE_YAML_OPERATOR, 63132, L"Operator", L"fore:#333366", L"" },
                        { -1, 00000, L"", L"", L"" } } };

KeywordList KeyWords_VHDL = { "access after alias all architecture array assert attribute begin block "
...
EditLexer *pLexArray[NUMLEXERS] = { &lexDefault,  &lexANSI,  &lexAVS,  &lexCONF, // Apache Config Scripts
    ...
    for (iLexer = 0; iLexer < NUMLEXERS; iLexer++) {
        ...
        while (pLexArray[iLexer]->Styles[i].iStyle != -1) {
            IniSectionGetString(pIniSection, pLexArray[iLexer]->Styles[i].pszName,
                                pLexArray[iLexer]->Styles[i].pszDefault, pLexArray[iLexer]->Styles[i].szValue,
...
BOOL Style_Import(HWND hwnd) {
    ...
    ofn.Flags = OFN_FILEMUSTEXIST | OFN_HIDEREADONLY | OFN_NOCHANGEDIR | OFN_DONTADDTORECENT | OFN_PATHMUSTEXIST |
...
BOOL Style_Export(HWND hwnd) {
    ...
    ofn.nMaxFile = dimof(szFile);
    ofn.Flags = /*OFN_FILEMUSTEXIST |*/ OFN_HIDEREADONLY | OFN_NOCHANGEDIR | OFN_DONTADDTORECENT | OFN_PATHMUSTEXIST |
                OFN_SHAREAWARE /*| OFN_NODEREFERENCELINKS*/ | OFN_OVERWRITEPROMPT;
...
void Style_SetLexer(HWND hwnd, EditLexer *pLexNew) {
    ...
    if (Style_StrGetSize(lexDefault.Styles[7 + iIdx].szValue, &iValue)) {
        ...
        lstrcpyn(wchStyle, lexDefault.Styles[7 + iIdx].szValue, dimof(lexDefault.Styles[0].szValue));

        iValue = max(min(iValue, 5), 0);
        wsprintf(lexDefault.Styles[7 + iIdx].szValue, L"size:%i", iValue);

        if (Style_StrGetColor(TRUE, wchStyle, &rgb)) {
            wsprintf(tch, L"; fore:#%02X%02X%02X", (int)GetRValue(rgb), (int)GetGValue(rgb), (int)GetBValue(rgb));
            lstrcat(lexDefault.Styles[7 + iIdx].szValue, tch);
        }

        if (Style_StrGetColor(FALSE, wchStyle, &rgb)) {
            wsprintf(tch, L"; back:#%02X%02X%02X", (int)GetRValue(rgb), (int)GetGValue(rgb), (int)GetBValue(rgb));
            lstrcat(lexDefault.Styles[7 + iIdx].szValue, tch);
        }
    }
    ...
    if (!Style_StrGetColor(TRUE, lexDefault.Styles[9 + iIdx].szValue, &rgb))
        ...
        WCHAR wch[32];
        wsprintf(wch, L"fore:#%02X%02X%02X", (int)GetRValue(rgb), (int)GetGValue(rgb), (int)GetBValue(rgb));
        if (lstrlen(wchCaretStyle))
            lstrcat(wchCaretStyle, L"; ");
        lstrcat(wchCaretStyle, wch);
    }
    ...
    { // set folding style; braces are for scoping only
        static const int iMarkerIDs[] = { SC_MARKNUM_FOLDEROPEN,   SC_MARKNUM_FOLDER,    SC_MARKNUM_FOLDERSUB,
    ...
    if (pLexNew->iLexer != SCLEX_NULL || pLexNew == &lexANSI) {
        ...
        while (pLexNew->Styles[i].iStyle != -1) {
            ...
            if (pLexNew->iLexer == SCLEX_HTML && pLexNew->Styles[i].iStyle8[0] == SCE_HPHP_DEFAULT) {
                int iRelated[] = { SCE_HPHP_COMMENT,         SCE_HPHP_COMMENTLINE,  SCE_HPHP_WORD,
                                   SCE_HPHP_HSTRING,         SCE_HPHP_SIMPLESTRING, SCE_HPHP_NUMBER,
                                   SCE_HPHP_OPERATOR,        SCE_HPHP_VARIABLE,     SCE_HPHP_HSTRING_VARIABLE,
            ...
            if (pLexNew->iLexer == SCLEX_HTML && pLexNew->Styles[i].iStyle8[0] == SCE_HJ_DEFAULT) {
                int iRelated[] = { SCE_HJ_COMMENT, SCE_HJ_COMMENTLINE,  SCE_HJ_COMMENTDOC,   SCE_HJ_KEYWORD,
                                   SCE_HJ_WORD,    SCE_HJ_DOUBLESTRING, SCE_HJ_SINGLESTRING, SCE_HJ_STRINGEOL,
                                   SCE_HJ_REGEX,   SCE_HJ_NUMBER,       SCE_HJ_SYMBOLS };
                for (j = 0; j < dimof(iRelated); j++)
                    Style_SetStyles(hwnd, iRelated[j], pLexNew->Styles[i].szValue);
            }
            ...
            if (pLexNew->iLexer == SCLEX_HTML && pLexNew->Styles[i].iStyle8[0] == SCE_HJA_DEFAULT) {
                int iRelated[] = { SCE_HJA_COMMENT, SCE_HJA_COMMENTLINE,  SCE_HJA_COMMENTDOC,   SCE_HJA_KEYWORD,
                                   SCE_HJA_WORD,    SCE_HJA_DOUBLESTRING, SCE_HJA_SINGLESTRING, SCE_HJA_STRINGEOL,
                                   SCE_HJA_REGEX,   SCE_HJA_NUMBER,       SCE_HJA_SYMBOLS };
                for (j = 0; j < dimof(iRelated); j++)
                    Style_SetStyles(hwnd, iRelated[j], pLexNew->Styles[i].szValue);
            }
            ...
            if ((pLexNew->iLexer == SCLEX_HTML || pLexNew->iLexer == SCLEX_XML) &&
                ...
                int iRelated[] = { SCE_H_SGML_COMMAND,      SCE_H_SGML_1ST_PARAM, SCE_H_SGML_DOUBLESTRING,
                                   SCE_H_SGML_SIMPLESTRING, SCE_H_SGML_ERROR,     SCE_H_SGML_SPECIAL,
                                   SCE_H_SGML_ENTITY,       SCE_H_SGML_COMMENT,   SCE_H_SGML_1ST_PARAM_COMMENT,
            ...
            if ((pLexNew->iLexer == SCLEX_HTML || pLexNew->iLexer == SCLEX_XML) &&
                ...
                int iRelated[] = { SCE_HP_START,        SCE_HP_DEFAULT,       SCE_HP_COMMENTLINE, SCE_HP_NUMBER,
                                   SCE_HP_STRING,       SCE_HP_CHARACTER,     SCE_HP_WORD,        SCE_HP_TRIPLE,
                                   SCE_HP_TRIPLEDOUBLE, SCE_HP_CLASSNAME,     SCE_HP_DEFNAME,     SCE_HP_OPERATOR,
                                   SCE_HP_IDENTIFIER,   SCE_HPA_START,        SCE_HPA_DEFAULT,    SCE_HPA_COMMENTLINE,
                                   SCE_HPA_NUMBER,      SCE_HPA_STRING,       SCE_HPA_CHARACTER,  SCE_HPA_WORD,
            ...
            if (pLexNew->iLexer == SCLEX_XML && pLexNew->Styles[i].iStyle8[0] == SCE_H_CDATA) {
                int iRelated[] = {
                    SCE_H_SCRIPT,         SCE_H_ASP,                 SCE_H_ASPAT,               SCE_H_QUESTION,
                    SCE_HPHP_DEFAULT,     SCE_HPHP_COMMENT,          SCE_HPHP_COMMENTLINE,      SCE_HPHP_WORD,
                    SCE_HPHP_HSTRING,     SCE_HPHP_SIMPLESTRING,     SCE_HPHP_NUMBER,           SCE_HPHP_OPERATOR,
                    SCE_HPHP_VARIABLE,    SCE_HPHP_HSTRING_VARIABLE, SCE_HPHP_COMPLEX_VARIABLE, SCE_HJ_START,
                    SCE_HJ_DEFAULT,       SCE_HJ_COMMENT,            SCE_HJ_COMMENTLINE,        SCE_HJ_COMMENTDOC,
                    SCE_HJ_KEYWORD,       SCE_HJ_WORD,               SCE_HJ_DOUBLESTRING,       SCE_HJ_SINGLESTRING,
                    SCE_HJ_STRINGEOL,     SCE_HJ_REGEX,              SCE_HJ_NUMBER,             SCE_HJ_SYMBOLS,
                    SCE_HJA_START,        SCE_HJA_DEFAULT,           SCE_HJA_COMMENT,           SCE_HJA_COMMENTLINE,
                    SCE_HJA_COMMENTDOC,   SCE_HJA_KEYWORD,           SCE_HJA_WORD,              SCE_HJA_DOUBLESTRING,
                    SCE_HJA_SINGLESTRING, SCE_HJA_STRINGEOL,         SCE_HJA_REGEX,             SCE_HJA_NUMBER,
                    SCE_HJA_SYMBOLS,      SCE_HB_START,              SCE_HB_DEFAULT,            SCE_HB_COMMENTLINE,
                    SCE_HB_WORD,          SCE_HB_IDENTIFIER,         SCE_HB_STRING,             SCE_HB_STRINGEOL,
                    SCE_HB_NUMBER,        SCE_HBA_START,             SCE_HBA_DEFAULT,           SCE_HBA_COMMENTLINE,
                    SCE_HBA_WORD,         SCE_HBA_IDENTIFIER,        SCE_HBA_STRING,            SCE_HBA_STRINGEOL,
                    SCE_HBA_NUMBER,       SCE_HP_START,              SCE_HP_DEFAULT,            SCE_HP_COMMENTLINE,
                    SCE_HP_NUMBER,        SCE_HP_STRING,             SCE_HP_CHARACTER,          SCE_HP_WORD,
                    SCE_HP_TRIPLE,        SCE_HP_TRIPLEDOUBLE,       SCE_HP_CLASSNAME,          SCE_HP_DEFNAME,
                    SCE_HP_OPERATOR,      SCE_HP_IDENTIFIER,         SCE_HPA_START,             SCE_HPA_DEFAULT,
                    SCE_HPA_COMMENTLINE,  SCE_HPA_NUMBER,            SCE_HPA_STRING,            SCE_HPA_CHARACTER,
                    SCE_HPA_WORD,         SCE_HPA_TRIPLE,            SCE_HPA_TRIPLEDOUBLE,      SCE_HPA_CLASSNAME,
                    SCE_HPA_DEFNAME,      SCE_HPA_OPERATOR,          SCE_HPA_IDENTIFIER
                };
                for (j = 0; j < dimof(iRelated); j++)
                    Style_SetStyles(hwnd, iRelated[j], pLexNew->Styles[i].szValue);
            }
            ...
            if (pLexNew->iLexer == SCLEX_CPP && pLexNew->Styles[i].iStyle8[0] == SCE_C_COMMENT) {
                int iRelated[] = { SCE_C_COMMENTLINE, SCE_C_COMMENTDOC, SCE_C_COMMENTLINEDOC, SCE_C_COMMENTDOCKEYWORD,
...
void Style_SetHTMLLexer(HWND hwnd) { Style_SetLexer(hwnd, Style_MatchLexer(L"Web Source Code", TRUE)); }
...
void Style_SetDefaultFont(HWND hwnd) {
    int iIdx = (bUse2ndDefaultStyle) ? 12 : 0;
    if (Style_SelectFont(hwnd, lexDefault.Styles[0 + iIdx].szValue, dimof(lexDefault.Styles[0].szValue), TRUE)) {
...
BOOL Style_StrGetFontQuality(const WCHAR *lpszStyle, WCHAR *lpszQuality, int cchQuality) {
    ...
    if (p = StrStrI(lpszStyle, L"smoothing:")) {
        ...
        if (p = StrChr(tch, L';'))
            *p = L'\0';
        TrimString(tch);
        if (lstrcmpi(tch, L"none") == 0 || lstrcmpi(tch, L"standard") == 0 || lstrcmpi(tch, L"cleartype") == 0 ||
...
BOOL Style_SelectFont(HWND hwnd, WCHAR *lpszStyle, int cchStyle, BOOL bDefaultStyle) {
    ...
    if (Style_StrGetColor(TRUE, lpszStyle, &iValue)) {
        wsprintf(tch, L"; fore:#%02X%02X%02X", (int)GetRValue(iValue), (int)GetGValue(iValue), (int)GetBValue(iValue));
        lstrcat(szNewStyle, tch);
    }
    if (Style_StrGetColor(FALSE, lpszStyle, &iValue)) {
        wsprintf(tch, L"; back:#%02X%02X%02X", (int)GetRValue(iValue), (int)GetGValue(iValue), (int)GetBValue(iValue));
        lstrcat(szNewStyle, tch);
    }
...
void Style_SetFontQuality(HWND hwnd, const WCHAR *lpszStyle) {
    ...
    if (Style_StrGetFontQuality(lpszStyle, tch, dimof(tch))) {
        ...
        WCHAR tch[32];
        if (Style_StrGetFont(lpszStyle, tch, dimof(tch))) {
            if (lstrcmpi(tch, L"Calibri") == 0 || lstrcmpi(tch, L"Cambria") == 0 || lstrcmpi(tch, L"Candara") == 0 ||
                lstrcmpi(tch, L"Consolas") == 0 || lstrcmpi(tch, L"Constantia") == 0 || lstrcmpi(tch, L"Corbel") == 0 ||
...
INT_PTR CALLBACK Style_ConfigDlgProc(HWND hwnd, UINT umsg, WPARAM wParam, LPARAM lParam) {
    ...
    switch (umsg) {
        ...
        case WM_INITDIALOG: {
            ...
            TreeView_SetImageList(hwndTV, (HIMAGELIST)SHGetFileInfo(L"C:\\", 0, &shfi, sizeof(SHFILEINFO),
            ...
            SendDlgItemMessage(hwnd, IDC_STYLEEDIT, EM_LIMITTEXT, dimof(lexDefault.Styles[0].szValue) - 1, 0);
            ...
            switch (LOWORD(wParam)) {
                ...
                case IDC_PREVSTYLE:
                    if (TreeView_GetSelection(hwndTV))
                        TreeView_Select(hwndTV, TreeView_GetPrevVisible(hwndTV, TreeView_GetSelection(hwndTV)),
                                        TVGN_CARET);
                ...
                case IDC_NEXTSTYLE:
                    if (TreeView_GetSelection(hwndTV))
                        TreeView_Select(hwndTV, TreeView_GetNextVisible(hwndTV, TreeView_GetSelection(hwndTV)),
                                        TVGN_CARET);
                    PostMessage(hwnd, WM_NEXTDLGCTL, (WPARAM)(GetDlgItem(hwnd, IDC_STYLEEDIT)), 1);
                    break;
                ...
                case IDC_STYLEFONT:
                    if (pCurrentStyle) {
                        ...
                        if (Style_SelectFont(hwnd, tch, dimof(tch),
...
void Style_ConfigDlg(HWND hwnd) {
    ...
    if (IDCANCEL == ThemedDialogBoxParam(g_hInstance, MAKEINTRESOURCE(IDD_STYLECONFIG), GetParent(hwnd),
                                         Style_ConfigDlgProc, (LPARAM)&StyleBackup)) {
        // Restore Styles
        c = 0;
        for (iLexer = 0; iLexer < NUMLEXERS; iLexer++) {
...
INT_PTR CALLBACK Style_SelectLexerDlgProc(HWND hwnd, UINT umsg, WPARAM wParam, LPARAM lParam) {
    ...
    switch (umsg) {
        ...
        case WM_INITDIALOG: {
            ...
            GetMenuString(GetSystemMenu(GetParent(hwnd), FALSE), SC_SIZE, tch, dimof(tch), MF_BYCOMMAND);
            ...
            SetWindowLongPtr(GetDlgItem(hwnd, IDC_RESIZEGRIP3), GWL_STYLE,
                             GetWindowLongPtr(GetDlgItem(hwnd, IDC_RESIZEGRIP3), GWL_STYLE) | SBS_SIZEGRIP |
                                 WS_CLIPSIBLINGS);

            cGrip = GetSystemMetrics(SM_CXHTHUMB);
            SetWindowPos(GetDlgItem(hwnd, IDC_RESIZEGRIP3), NULL, cxClient - cGrip, cyClient - cGrip, cGrip, cGrip,
                         SWP_NOZORDER);

            hwndLV = GetDlgItem(hwnd, IDC_STYLELIST);

            ListView_SetImageList(hwndLV, (HIMAGELIST)SHGetFileInfo(L"C:\\", 0, &shfi, sizeof(SHFILEINFO),
                                                                    SHGFI_SMALLICON | SHGFI_SYSICONINDEX),
                                  LVSIL_SMALL);
        ...
        case WM_SIZE: {
            ...
            SetWindowPos(GetDlgItem(hwnd, IDC_RESIZEGRIP3), NULL, rc.left + dxClient, rc.top + dyClient, 0, 0,
            ...
            MapWindowPoints(NULL, hwnd, (LPPOINT)&rc, 2);
            SetWindowPos(GetDlgItem(hwnd, IDCANCEL), NULL, rc.left + dxClient, rc.top + dyClient, 0, 0,
                         SWP_NOZORDER | SWP_NOSIZE);
            ...
            MapWindowPoints(NULL, hwnd, (LPPOINT)&rc, 2);
            SetWindowPos(GetDlgItem(hwnd, IDC_DEFAULTSCHEME), NULL, rc.left, rc.top + dyClient, 0, 0,
                         SWP_NOZORDER | SWP_NOSIZE);
